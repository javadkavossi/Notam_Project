...
func (l *zapLogger) Init() {
	once.Do(func() {
		...
		w := zapcore.AddSync(&lumberjack.Logger{
			Filename:   fileName,
			MaxSize:    100,  // مگابایت - حداکثر اندازه هر فایل لاگ
			MaxBackups: 0,    // بدون backup - فقط یک فایل لاگ (حداکثر 100 مگابایت)
			MaxAge:     7,    // روز - فایل‌های قدیمی‌تر از 7 روز حذف می‌شوند
			Compress:   true, // فایل‌های قدیمی را zip کن
			LocalTime:  true,
		})
